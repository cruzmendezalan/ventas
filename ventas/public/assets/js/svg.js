  ...
  Main = (function() {
    ...
    Main.prototype.launchClouds = function() {
      ...
      this.cloud1Tween = new TWEEN.Tween({
        ...
        return cloud1.setAttribute('transform', "translate(" + "10" + ")");
      ...
      this.cloud11Tween = new TWEEN.Tween({
        ...
        return cloud11.setAttribute('transform', "translate(" + "10" + ")");
      ...
      this.cloud2Tween = new TWEEN.Tween({
        ...
        return cloud2.setAttribute('transform', "translate(" + "10" + ")");
      }).repeat(9999999).start({
        progress: .25
      });
      this.cloud21Tween = new TWEEN.Tween({
        ...
        return cloud21.setAttribute('transform', "translate(" + "10" + ")");
      }).repeat(9999999).delay(time / 2).start({
        progress: .25
      });
      ...
      this.cloud3Tween = new TWEEN.Tween({
        ...
        return cloud3.setAttribute('transform', "translate(" + "10" + ")");
      }).repeat(9999999).start({
        progress: .75
      });
      this.cloud31Tween = new TWEEN.Tween({
        ...
        return cloud31.setAttribute('transform', "translate(" + "10" + ")");
      }).repeat(9999999).delay(time / 2).start({
        progress: .75
      });
      ...
      this.cloud4Tween = new TWEEN.Tween({
        ...
        return cloud4.setAttribute('transform', "translate(" + "10" + ")");
      }).repeat(9999999).start();
      return this.cloud41Tween = new TWEEN.Tween({
        ...
        return cloud41.setAttribute('transform', "translate(" + "10" + ")");
      }).repeat(9999999).delay(time / 2).start();
    };
